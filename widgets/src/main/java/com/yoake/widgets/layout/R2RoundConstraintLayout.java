...
public class R2RoundConstraintLayout extends ConstraintLayout implements Checkable, RCAttrs {
    RCHelper mRCHelper;

    public R2RoundConstraintLayout(Context context) {
        this(context, null);
    }

    public R2RoundConstraintLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public R2RoundConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
