...
public class R2RoundRelativeLayout extends RelativeLayout implements Checkable, RCAttrs {
    RCHelper mRCHelper;

    public R2RoundRelativeLayout(Context context) {
        this(context, null);
    }

    public R2RoundRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public R2RoundRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
