...
public class R2RoundLinearLayout extends LinearLayout implements Checkable, RCAttrs {
    RCHelper mRCHelper;

    public R2RoundLinearLayout(Context context) {
        this(context, null);
    }

    public R2RoundLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public R2RoundLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
