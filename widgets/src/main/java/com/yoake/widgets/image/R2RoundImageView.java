 ...
 *
 */
public class R2RoundImageView extends AppCompatImageView {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.R2RoundImageView, defStyleAttr, 0);

        mBorderWidth = array.getDimensionPixelSize(R.styleable.R2RoundImageView_r2iv_border_width, 0);
        mBorderColor = array.getColor(R.styleable.R2RoundImageView_r2iv_border_color, DEFAULT_BORDER_COLOR);
        mSelectedBorderWidth = array.getDimensionPixelSize(
                R.styleable.R2RoundImageView_r2iv_selected_border_width, mBorderWidth);
        mSelectedBorderColor = array.getColor(R.styleable.R2RoundImageView_r2iv_selected_border_color, mBorderColor);
        mSelectedMaskColor = array.getColor(R.styleable.R2RoundImageView_r2iv_selected_mask_color, Color.TRANSPARENT);
        ...
        mIsTouchSelectModeEnabled = array.getBoolean(R.styleable.R2RoundImageView_r2iv_is_touch_select_mode_enabled, true);
        mIsCircle = array.getBoolean(R.styleable.R2RoundImageView_r2iv_is_circle, false);
        if (!mIsCircle) {
            mIsOval = array.getBoolean(R.styleable.R2RoundImageView_r2iv_is_oval, false);
        }
        if (!mIsOval) {
            mCornerRadius = array.getDimensionPixelSize(R.styleable.R2RoundImageView_r2iv_corner_radius, 0);
        }
        array.recycle();
    }
