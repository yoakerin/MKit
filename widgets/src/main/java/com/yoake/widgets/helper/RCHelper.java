...
public class RCHelper {
    ...
    public void initAttrs(Context context, AttributeSet attrs) {
        ...
        mRoundAsCircle = ta.getBoolean(R.styleable.RCAttrs_r2round_as_circle, false);
        mStrokeColorStateList = ta.getColorStateList(R.styleable.RCAttrs_r2round_stroke_color);
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.RCAttrs_r2round_stroke_width, 0);
        mClipBackground = ta.getBoolean(R.styleable.RCAttrs_r2round_clip_background, false);
        int roundCorner = ta.getDimensionPixelSize(R.styleable.RCAttrs_r2round_corner, 0);
        int roundCornerTopLeft = ta.getDimensionPixelSize(
                R.styleable.RCAttrs_r2round_corner_top_left, roundCorner);
        int roundCornerTopRight = ta.getDimensionPixelSize(
                R.styleable.RCAttrs_r2round_corner_top_right, roundCorner);
        int roundCornerBottomLeft = ta.getDimensionPixelSize(
                R.styleable.RCAttrs_r2round_corner_bottom_left, roundCorner);
        int roundCornerBottomRight = ta.getDimensionPixelSize(
                R.styleable.RCAttrs_r2round_corner_bottom_right, roundCorner);
        ta.recycle();
